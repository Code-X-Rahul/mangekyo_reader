        ...
        <div className="px-1">
            ...
            <div className='flex justify-start items-center'>
                <div className='grid gap-1 grid-flow-col px-1 py-2 bg-zinc-800 h-auto overflow-x-scroll hide-scrollbar'>
                    {characters?.map((c) => (
                        <Link to={`../${title}/character/${c.id}`} className={` relative w-[8rem] h-60 overflow-hidden bg-sky-300 rounded-sm hover:scale-105 transition-all ease-in grid`} key={c.id}>
